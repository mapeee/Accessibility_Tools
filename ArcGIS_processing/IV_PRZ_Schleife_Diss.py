# -*- coding: cp1252 -*-
#!/usr/bin/python
#Skript, mit dem die Anbindungen fuer nicht im MRH-Projekt verwendete Raumbezugssysteme berechnet werden.
#Marcus August 2019
#für Python 2.7.5
...
ID_A = "Start_ID"
ID_S = "Start_ID"
if NMIV is True: Group_Erg = "Ergebnisse_NMIV"
else: Group_Erg = "PRZ_MIV"
...
for Bezug in Bezuege:
    ...
    if "_100" not in Bezug[2]: continue
    ...
    arcpy.MakeFeatureLayer_management(Bezug[0], "A_Shape")
    ...
    if NMIV == True: field_mappings = "Name "+Bezug[1]+" 0; SourceID SourceID_NMIV 0;SourceOID SourceOID_NMIV 0;PosAlong PosAlong_NMIV 0;SideOfEdge SideOfEdge_NMIV 0"
    else: field_mappings = "Name "+Bezug[1]+" 0; SourceID SourceID_MIV 0;SourceOID SourceOID_MIV 0;PosAlong PosAlong_MIV 0;SideOfEdge SideOfEdge_MIV 0"
...
#        if "C:"+f[1]+"Punkte_Admin/MRH_Kita_2019" != g[0]: continue 
        ...
        if NMIV == True: Tabelle_E = g[2]+"_NMIV"+Bezug[2]
        else: Tabelle_E = g[2]+"_MIV"+Bezug[2]
        Filter_S = g[1]
        S_Shape = g[0]
    
        print g[0]
        #--Generierung weiterer Parameter--#
        text = "Datum: "+str(time.localtime()[0:3])+", Modus: " +Modus+", Tabelle_A: "+Bezug[0]+", Tabelle_S: "+Tabelle_E+ " NMIV-Radius: "+str(Radius)+" Minuten: "+str(Max_Kosten)
        ...
        else: field_mappings = "Name "+S_Shape_ID+" 0; SourceID SourceID_MIV 0;SourceOID SourceOID_MIV 0;PosAlong PosAlong_MIV 0;SideOfEdge SideOfEdge_MIV 0"
