...
for Bezug in Bezuege:
    ...
    else: field_mappings = "Name "+Bezug[1]+" 0; SourceID SourceID_MIV 0;SourceOID SourceOID_MIV 0;PosAlong PosAlong_MIV 0;SideOfEdge SideOfEdge_MIV 0; Attr_tAkt tAb 1"
...
#        if "C:/Geodaten/Material.gdb/Punkte_Admin/MRH_Kita_2019" != g[0]: continue 
