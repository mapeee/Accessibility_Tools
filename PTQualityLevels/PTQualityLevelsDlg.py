...
class MyDialog(wx.Dialog):
    def __init__(self, parent, title):
        super(MyDialog, self).__init__(parent, id=-1, title=title, style=wx.DEFAULT_DIALOG_STYLE | wx.RESIZE_BORDER | wx.STAY_ON_TOP)
    ...
    def __InitUI(self):
        ...
        self.combo_day = wx.ComboBox(self.panel, -1, "")
        self.label_ti = wx.StaticText(self.panel, -1, _("Time intervals"))
        self.list_ti = List_ti(self.panel)
        self.list_ti.Bind(wx.EVT_LIST_END_LABEL_EDIT, self.OnEditTi)
        self.button_ti = wx.Button(self.panel, -1, _("Add"))
        self.button_ti_remove = wx.Button(self.panel, -1, _("Remove"))
        self.Bind(wx.EVT_BUTTON, self.OnAddTi, self.button_ti)
        self.Bind(wx.EVT_BUTTON, self.OnRemoveTi, self.button_ti_remove)
        
        # stop types
        self.label_st = wx.StaticText(self.panel, -1, _("Stop types"))
        self.label_mode = wx.StaticText(self.panel, -1, _("Aggregation level"))
        self.combo_mode = wx.ComboBox(self.panel, -1, "")
        self.dvlc_scml = dv.DataViewListCtrl(self.panel, -1, style=wx.BORDER_SUNKEN)
        self.Bind(wx.EVT_COMBOBOX, self.OnModeChanged, self.combo_mode)
        
        # stop categories
        self.label_sc = wx.StaticText(self.panel, -1, _("Stop categories"))
        self.label1_sc = wx.StaticText(self.panel, -1, _("F1: service frequency 1"))
        self.label2_sc = wx.StaticText(self.panel, -1, _("F2: service frequency 2"))
        self.label3_sc = wx.StaticText(self.panel, -1, _("F3: service frequency 3"))
        self.label4_sc = wx.StaticText(self.panel, -1, _("F4: service frequency 4"))
        self.label5_sc = wx.StaticText(self.panel, -1, _("F5: service frequency 5"))
        self.label6_sc = wx.StaticText(self.panel, -1, _("F6: service frequency 6"))
        self.spin1_sc = wx.SpinCtrl(self.panel, id=0, min=0, max=100, initial=24)
        self.spin2_sc = wx.SpinCtrl(self.panel, id=1, min=0, max=100, initial=12)
        self.spin3_sc = wx.SpinCtrl(self.panel, id=2, min=0, max=100, initial=6)
        self.spin4_sc = wx.SpinCtrl(self.panel, id=3, min=0, max=100, initial=4)
        self.spin5_sc = wx.SpinCtrl(self.panel, id=4, min=0, max=100, initial=2)
        self.spin6_sc = wx.SpinCtrl(self.panel, id=5, min=0, max=100, initial=1)
        ...
        # service areas
        self.label_sa = wx.StaticText(self.panel, -1, _("Service areas"))
        self.label1_sa = wx.StaticText(self.panel, -1, _("E1: distance 1"))
        self.label2_sa = wx.StaticText(self.panel, -1, _("E2: distance 2"))
        self.label3_sa = wx.StaticText(self.panel, -1, _("E3: distance 3"))
        self.label4_sa = wx.StaticText(self.panel, -1, _("E4: distance 4"))
        self.label5_sa = wx.StaticText(self.panel, -1, _("E5: distance 5"))
        self.spin1_sa = wx.SpinCtrl(self.panel, id=6, min=0, max=5000, initial=300)
        self.spin2_sa = wx.SpinCtrl(self.panel, id=7, min=0, max=5000, initial=400)
        self.spin3_sa = wx.SpinCtrl(self.panel, id=8, min=0, max=5000, initial=600)
        self.spin4_sa = wx.SpinCtrl(self.panel, id=9, min=0, max=5000, initial=1000)
        self.spin5_sa = wx.SpinCtrl(self.panel, id=10, min=0, max=5000, initial=1500)
        ...
        # clip
        self.label_clip = wx.StaticText(self.panel, -1, _("Use Clip polygons"))
        self.cb_clip = wx.CheckBox(self.panel, -1, "")
        self.listbox_clip = wx.ListBox(self.panel)
        self.button_add_clip = wx.Button(self.panel, -1, _("Add files..."))
        self.button_remove_clip = wx.Button(self.panel, -1, _("Remove"))
        ...
        # end
        self.button_ok = wx.Button(self.panel, -1, _("OK"))
        self.button_help = wx.Button(self.panel, -1, _("Help"))
        self.button_info = wx.Button(self.panel, -1, _("Info"))
        self.button_exit = wx.Button(self.panel, wx.ID_CANCEL, _("Close"))
    ...
    def __do_layout(self):
        ...
        sb_st = wx.StaticBox(self.panel, -1, "")
        ...
        grid_st_left.Add(wx.StaticText(self.panel, -1, "/h"), pos=(1,2), flag = wx.ALIGN_CENTER_VERTICAL)
        ...
        grid_st_left.Add(wx.StaticText(self.panel, -1, "/h"), pos=(2,2), flag = wx.ALIGN_CENTER_VERTICAL)
        ...
        grid_st_left.Add(wx.StaticText(self.panel, -1, "/h"), pos=(3,2), flag = wx.ALIGN_CENTER_VERTICAL)
        ...
        grid_st_left.Add(wx.StaticText(self.panel, -1, "/h"), pos=(4,2), flag = wx.ALIGN_CENTER_VERTICAL)
        ...
        grid_st_left.Add(wx.StaticText(self.panel, -1, "/h"), pos=(5,2), flag = wx.ALIGN_CENTER_VERTICAL)
        ...
        grid_st_left.Add(wx.StaticText(self.panel, -1, "/h"), pos=(6,2), flag = wx.ALIGN_CENTER_VERTICAL)
        ...
        grid_st_right.Add(wx.StaticText(self.panel, -1, "m"), pos=(1,2), flag = wx.ALIGN_CENTER_VERTICAL)
        ...
        grid_st_right.Add(wx.StaticText(self.panel, -1, "m"), pos=(2,2), flag = wx.ALIGN_CENTER_VERTICAL)
        ...
        grid_st_right.Add(wx.StaticText(self.panel, -1, "m"), pos=(3,2), flag = wx.ALIGN_CENTER_VERTICAL)
        ...
        grid_st_right.Add(wx.StaticText(self.panel, -1, "m"), pos=(4,2), flag = wx.ALIGN_CENTER_VERTICAL)
        ...
        grid_st_right.Add(wx.StaticText(self.panel, -1, "m"), pos=(5,2), flag = wx.ALIGN_CENTER_VERTICAL)
        ...
        # Parameters
        sb_para = wx.StaticBox(self.panel, -1, _("Parameters"))
        ...
        # End
        sb_end = wx.StaticBox(self.panel, -1, _("End"))
